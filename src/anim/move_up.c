...
//             sfSoundBuffer *sound_door = \
// sfSoundBuffer_createFromFile("ressources/Audio/door.ogg");
//             sfSound_setBuffer(game->door, sound_door);
//             sfSound_setVolume(game->door, 10);
//             sfSound_play(game->door);
            game->cur_scn = 8;
            perso->pos.x = 926;
            perso->pos.y = 632;
        }
